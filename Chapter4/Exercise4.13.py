...
if status == 0: # Compute tax for single filers
...
elif status == 1: # Compute tax for married filling jointly
    if income <= 16700:
        tax = income * 0.10
    elif income <= 67900:
...
elif status == 2: # Compute tax for married filling separately
    if income <= 8350:
        tax = income * 0.10
    elif income <= 33950:
        tax = 8350 * 0.10 + (income - 8350) * 0.15
    ...
    if income <= 11950:
        ...
        tax = 11950 * 0.10 + (49500 - 11950) * 0.15 + \
              (income - 49500) * 0.25
    elif income <= 190200:
        tax = 11950 * 0.10 + (49500 - 11950) * 0.15 + \
              (117450 - 49500) * 0.25 + (income - 117450) * 0.28
    elif income <= 372950:
        tax = 11950 * 0.10 + (49500 - 11950) * 0.15 + \
              (117450 - 49500) * 0.25 + (190200 - 117450) * 0.28 + \
              (income - 190200) * 0.33
    else:
        tax = 11950 * 0.10 + (49500 - 11450) * 0.15 + \
              (117450 - 49500) * 0.25 + (190200 - 117450) * 0.28 + \
